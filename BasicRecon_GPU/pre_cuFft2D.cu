...
__global__ void fftshift(cusp::complex<float> * d_idata, cusp::complex<float> * d_odata)
{
...
__global__  void ComplexScale(cusp::complex<float>* d_idata, cusp::complex<float>* d_odata, float scale, unsigned int width, unsigned int height)
{
