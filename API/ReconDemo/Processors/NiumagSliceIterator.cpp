...
NiumagSliceIterator::NiumagSliceIterator() :
    ProcessorImpl(L"NiumagSliceIterator")
{
   // LOG_TRACE(L"NiumagSliceIterator constructor called.", L"NiuMri");

    AddInput(L"Input", YAP_ANY_DIMENSION, DataTypeComplexFloat);
    AddOutput(L"Output", 2, DataTypeComplexFloat);
}

NiumagSliceIterator::NiumagSliceIterator(const NiumagSliceIterator &rhs) :
    ProcessorImpl(rhs)
{
    LOG_TRACE(L"NiumagSliceIterator constructor called.", L"NiuMri");
}
...
NiumagSliceIterator::~NiumagSliceIterator()
{
    //    LOG_TRACE(L"NiumagSliceIterator destructor called.", L"NiuMri");
}

bool NiumagSliceIterator::Input(const wchar_t *name, IData *data)
{
